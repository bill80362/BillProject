...
//            ResData::failValException($exception);
    ...
    public static function checkInt($_Data,$_Var){
        try{
            ...
            echo ResData::failValException($exception);
            exit();
        }
    }
    ...
    public static function checkStringLength($_Data,$minString,$maxString,$_Var,$returnURL){
        try{
            $Val = Val::noWhitespace()->length($minString,$maxString)->setName($_Var);
            $Val->check($_Data);
        }catch (ValidationException $exception){
            echo ResData::alert_redirect($_Var,$returnURL);
            exit();
        }
    }
